...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Check for any bullets that have hit aliens. If so, get rid if the bullet and the alien
    ...
    def _create_fleet(self):
        ...
        available_space_x = self.settings.screen_width - (2 * alien_width) # I changed it from available_space_x = self.settings.screen_width - (2 * alien_width)
        number_aliens_x = available_space_x // (2 * alien_width)

        #determin the number of aliens that fit on screen
